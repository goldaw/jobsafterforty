...
import { submitScope } from './actions/scopes';
...
class DialogAddScope extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <RaisedButton style={{ margin: 5 }} label="הוספת היקף משרה" onTouchTap={this.handleOpen} />
          <Dialog
            title="הוספת היקף משרה"
            actions={actions}
            modal={false}
          ...
          >
            ...
            <label htmlFor="name"><font className="reqLabel">*</font>שם היקף משרה</label><br />
...
export default connect(mapStateToProps, mapDispatchToProps)(DialogAddScope);
